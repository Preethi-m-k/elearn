                ...
                <div class="col-xl-6 offset-xl-0 col-lg-6 offset-lg-0 col-md-8 offset-md-2">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" id="registerForm">
                        ...
                        <div class="p-4">
                            ...
                            <div class="form-group">
                                <label>Mobile</label>
                                <input name="mobile" type="text" class="form-control form-control-sm" placeholder="Mobile Number" value="{{ old('mobile') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="inputBasicActive" name="roles" value="1" />
                                <label for="inputBasicActive">Student </label>
                            
                                <input type="radio" id="inputBasicInactive" name="roles" value="2" />
                                <label for="inputBasicInactive">Instructor</label>
