        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <div class="row cv-header">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                            <div class="cv-category-detail cv-enroll float-lg-right float-md-right float-sm-right">
                                ...
                                <button type="submit" class="btn btn-ulearn-cview mt-1">ENROLL COURSE </button>
                    ...
                    <div class="course-image mt-2">
                        <img src="@if(Storage::exists($course->course_image)){{ asset('storage/'.$course->course_image) }}@else{{ asset('backend/assets/images/course_detail.jpg') }}@endif">
                    </div>
